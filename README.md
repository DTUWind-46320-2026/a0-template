...
1. Install `a0pack` editably. In the main directory, `pip install -e .`.
1. Change into hawc_files folder: `cd hawc_files`  
1. Run the Python script: `python b_make_hawc2s.py`. This generates a HAWC2S input file
